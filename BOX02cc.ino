...
int indicateur19 = 19;
int indicateur20 = 20;
const char hostnameOBD[] = "carthage-decor.tn"; //cfl-lux.sfmtechnologies.net"; //sfm-cfl.sfmtechnologies.net"; //  http://41.230.59.41:2939/cfl/mesure/save  domain name: example.com, maker.ifttt.com, etc
const char hostname[] = "v-smart.sfmtechnologies.net";//sfm-cfl.sfmtechnologies.net"; //  http://41.230.59.41:2939/cfl/mesure/save  domain name: example.com, maker.ifttt.com, etc
const char resource[] = "/TTcphL75-./obd1520ba0.bin";         // resource path, for example: /post-data.php
const int  port = 8080;
const int  portOBD = 80;//29398;
